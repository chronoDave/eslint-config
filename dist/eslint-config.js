...
import stylistic$1 from '@stylistic/eslint-plugin-ts';
...
const key$2 = '@stylistic/js';

const plugins$2 = {
  [key$2]: stylistic
};

const rules$2 = Object.fromEntries(Object.entries({
...
const key$1 = '@stylistic/ts';

const plugins$1 = {
  [key$1]: stylistic$1
};

const rules$1 = Object.fromEntries(Object.entries({
  'block-spacing': ['error', 'always'],
  'brace-style': ['error', '1tbs'],
  'comma-dangle': ['error', 'never'],
  'comma-spacing': 'error',
...
const env = { browser, node };
const config = { base, typescript, ignore };
...
export { config, index as default, env };
